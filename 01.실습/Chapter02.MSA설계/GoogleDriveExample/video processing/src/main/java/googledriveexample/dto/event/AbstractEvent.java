...
import googledriveexample.config.kafka.KafkaConfiguration;
import googledriveexample.VideoProcessingApplication;
...
public class AbstractEvent {
    ...
    public void publish(Long key){
        ...
        KafkaConfiguration kafkaConfiguration = VideoProcessingApplication.applicationContext.getBean(KafkaConfiguration.class);
        Map<String, Object> headers = new HashMap<>();
        headers.put(KafkaHeaders.TOPIC, "googledriveexample");
