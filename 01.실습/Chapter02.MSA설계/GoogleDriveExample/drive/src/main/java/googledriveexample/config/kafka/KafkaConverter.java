...
package googledriveexample.config.kafka;
...
import googledriveexample.dto.event.FileDeleted;
...
public class KafkaConverter {
    ...
    public Object convertPayload(Object payload) {
        try {
            ...
            if (abstractEvent.getEventType().equals("FileUploaded")) {
                FileUploaded fileUploaded = objectMapper.readValue((String) payload, FileUploaded.class);
                return fileUploaded;
            }
            else if (abstractEvent.getEventType().equals("FileDeleted")) {
                FileDeleted fileDeleted = objectMapper.readValue((String) payload, FileDeleted.class);
                return fileDeleted;
            }
