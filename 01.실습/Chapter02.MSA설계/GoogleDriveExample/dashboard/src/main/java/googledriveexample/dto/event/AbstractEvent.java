...
import googledriveexample.DashboardApplication;
...
public class AbstractEvent {
    ...
    public void publish(Long key){
        ...
        KafkaConfiguration kafkaConfiguration = DashboardApplication.applicationContext.getBean(KafkaConfiguration.class);
