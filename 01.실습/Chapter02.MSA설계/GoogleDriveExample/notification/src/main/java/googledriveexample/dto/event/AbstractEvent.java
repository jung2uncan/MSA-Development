...
import googledriveexample.NotificationApplication;
...
public class AbstractEvent {
    ...
    public void publish(Long key){
        ...
        KafkaConfiguration kafkaConfiguration = NotificationApplication.applicationContext.getBean(KafkaConfiguration.class);
