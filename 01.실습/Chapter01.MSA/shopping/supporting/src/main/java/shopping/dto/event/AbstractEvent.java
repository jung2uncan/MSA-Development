...
import shopping.config.kafka.KafkaConfiguration;
import shopping.BoundedContext57_499961853027344Application;
...
public class AbstractEvent {
    ...
    public void publish(Long key){
        ...
        KafkaConfiguration kafkaConfiguration = BoundedContext57_499961853027344Application.applicationContext.getBean(KafkaConfiguration.class);
        Map<String, Object> headers = new HashMap<>();
        headers.put(KafkaHeaders.TOPIC, "shopping");
