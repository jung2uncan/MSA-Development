...
public class KafkaConverter {
    ...
    public Object convertPayload(Object payload) {
        try {
            ...
            if (abstractEvent.getEventType().equals("OrderPlaced")) {
                OrderPlaced orderPlaced = objectMapper.readValue((String) payload, OrderPlaced.class);
                return orderPlaced;
            }
            else if (abstractEvent.getEventType().equals("OrderCancled")) {
                OrderCancled orderCancled = objectMapper.readValue((String) payload, OrderCancled.class);
                return orderCancled;
            }
